    ...
    $(document).ready(function() {
        ...
        function tampildata() {
            $('#userGroup').DataTable({
                ...
                "ajax": {
                    url: "<?= base_url() ?>usergroup/datatables",
                    type: "POST",
                    data: function(d) {
                        d.search = $('#userGroup_filter input').val(); // Mengambil nilai pencarian dari input DataTable
                    }
                },
            });
        }
        ...
        $('#inputform').submit(function(e) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url() ?>usergroup/store",
